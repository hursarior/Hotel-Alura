...
public class Busqueda extends javax.swing.JFrame {
    ...
    private void BTNELIMINARMouseClicked(java.awt.event.MouseEvent evt) {
        ...
        int choice = JOptionPane.showConfirmDialog(
                null,
                "Si borra un huésped, este se borrará junto con la reservación que haya realizado. ¿Desea continuar?",
                "Confirmación",
        ...
        if (choice == JOptionPane.YES_OPTION) {
                ...
                nn.Eliminar(Id);
                javax.swing.JOptionPane.showMessageDialog(null,
                        "El Huesped se ha eliminado con Exito");
                MostrarTablaReserva();
                MostrarTablaHuespedes();
            ...
            javax.swing.JOptionPane.showMessageDialog(null,
                    "Debe borrar al Huesped de esta reservacion.");
    ...
    private void BTNEDITARMouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_BTNEDITARMouseClicked
        ...
        LocalDate fecha_nacimiento = LocalDate
                .parse(TablaHuespedes.getValueAt(TablaHuespedes.getSelectedRow(), 3).toString());
